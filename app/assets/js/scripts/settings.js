    ...
    authKeys.map((val) => {
        ...
        authAccountStr += `<div class="settingsAuthAccount" uuid="${acc.uuid}">
            <div class="settingsAuthAccountLeft">
                <img class="settingsAuthAccountImage" alt="${acc.displayName}" src="https://minotar.net/armor/body/${acc.uuid}.png">
            </div>
...
function populateReleaseNotes() {
    $.ajax({
        url: 'https://github.com/Craftok/Launcher/releases.atom',
        success: (data) => {
...
function populateSettingsUpdateInformation(data) {
    if (data != null) {
        settingsUpdateTitle.innerHTML = `Une nouvelle ${isPrerelease(data.version) ? 'Pre-release' : 'Release'} est disponible`
